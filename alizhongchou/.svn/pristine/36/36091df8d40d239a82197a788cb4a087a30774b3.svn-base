...
//modify by yagami at20160713 Ìí¼ÓêÇ³Æ
			$data['customers'][] = array(
		...
		$data['sort_nickname'] = $this->url->link('customer/customer', 'token=' . $this->session->data['token'] . '&sort=nickname' . $url, true);
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['nickname']) < 1) || (utf8_strlen(trim($this->request->post['nickname'])) > 17)) {
