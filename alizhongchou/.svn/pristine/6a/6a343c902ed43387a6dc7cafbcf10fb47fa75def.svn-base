	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=module/logancee&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
			...
			<div>
				...
				<div class="bg-tabs">
					...
					<div id="tab_install_data" class="tab-content">
						...
						<div class="input versions version-1 version-2 version-3 version-6 version-7 version-8 version-10 version-11 version-12">
						...
						<div class="input versions version-1 version-2 version-3 version-4 version-5 version-6 version-7 version-8 version-9 version-10 version-11 version-12">
