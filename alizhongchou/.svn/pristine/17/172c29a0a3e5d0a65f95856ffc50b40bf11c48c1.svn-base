...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
	    ...
	    if($this->customer->isLogged()){
		  $this->response->redirect($this->url->link('account/home', 'customer_id=' . $this->customer->getId()));
		}
		...
		$data['href'] = $this->url->link('account/forgotten','',true);
	...
	protected function validate() {
        ...
        //$this->config->get('config_login_attempts')
