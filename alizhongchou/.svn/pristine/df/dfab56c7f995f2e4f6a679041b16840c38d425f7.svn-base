...
#passwordReset .modal-header .close {
    margin-top: -5px;
    margin-right: -15px;
    font-size: 35px;
    color: #8c8c8c;
			...
			<div class="loginto col-md-offset-4 col-md-4">
				<div class="signin 	row">
					<div class="logo col-md-5">
						<img src="image/logo.png" alt="" style="width:100px;height:36px">
					</div>
					<ul class="col-md-offset-1 col-md-6 nav nav-tabs" id="myTablog">
						<li class="first-li l <?php if($function=='register'){echo 'active';}?>" name="1" style="border:0px"><span class="li_a" href="#up" style="color:#31b0d5;font-weight:blod">Change&nbsp;your&nbsp;password</span></li>
						
					</ul>
				</div>
				<div class="tab-content">
				<div class="row signinup  tab-pane <?php if($function=='login'){echo 'active';}?>" id="up">
						<form action="<?php  echo $action;?>" id="formbd" method="POST" name="register">
                           ...
                           <?php }?>
							...
							<div class="wellcome">
								<p class="wedl">For security purposes, we recommended not reusing an old password or a password used on another site.</p>
							</div>
							<div class="xhx">
