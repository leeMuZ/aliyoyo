<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
	  ...
	  <li><a href="<?php echo $reviews ?>">Project</a></li>
 ...
 <?php if($config_livehelp_state) { ?>
				<li id="livehelp"><a class="parent"><i class="fa fa-comment fa-fw"></i> <span><?php echo $text_livehelp; ?></span></a>
			        <ul>
			          <li><a href="<?php echo $livehelp_setting; ?>"><?php echo $text_livehelp_setting; ?></a></li>
			          <li><a href="<?php echo $livehelp_status; ?>"><?php echo $text_livehelp_status; ?></a></li>
			          <li><a href="<?php echo $livehelp_ban; ?>"><?php echo $text_livehelp_ban; ?></a></li>
			          <li><a href="<?php echo $livehelp_user; ?>"><?php echo $text_livehelp_user; ?></a></li>
					  <li><a href="<?php echo $livehelp_data_warehouse; ?>"><?php echo $text_livehelp_data_warehouse; ?></a></li>
			        </ul>
				</li>
				<?php } ?>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_product; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $report_product_search; ?>"><?php echo $text_report_product_search; ?></a></li>
        </ul>
      </li>
