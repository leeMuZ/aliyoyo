				...
				<div class="row signinup  tab-pane <?php if($function=='register'){echo 'active';}?>" id="up">
						<form action="<?php  echo $register;?>" id="formbd" method="POST" name="register">
                           ...
                           <?php }?>
							...
							<div class="wellcome">
								<p class="wedl">By signing up, you agree to our <span><a href="<?php echo $terms ?>">terms of use,</a> <a href="<?php echo $privacy ?>">privacy policy</a></span> and <span><a href="<?php echo $cook ?>">cookies policy</a></span></p>
							</div>
							<div class="xhx">
...
<div class="modal fade" id="passwordReset" tabindex="15" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
		  <form action="<?php  echo $href;?>" id="formbd" method="POST" name="login">
            <div class="modal-header">
                ...
                <h5 style="color: #5bc0de;" id="myModalmsg"></h5>
                    ...
                    <div style="padding-top: 10px;">
                        <input type="submit" class="btn btn-info" id="submit-forget-password" value="Continue">
