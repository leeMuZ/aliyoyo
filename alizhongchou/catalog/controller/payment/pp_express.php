...
class ControllerPaymentPPExpress extends Controller {
	...
	public function expressConfirm() {
		...
		if (isset($this->session->data['error_warning'])) {
			...
			if($data['error_warning'] == "A successful transaction has already been completed for this token."){
	...
	public function expressComplete() {
		...
		if ($redirect == '') {
			...
			$data['payment_telephone'] = isset($payment_address['telephone']) ? $payment_address['telephone'] : '';
			...
			if ($this->cart->hasShipping()) {
				...
				$data['shipping_telephone'] = isset($shipping_address['telephone']) ? $shipping_address['telephone'] : '';
			...
			if ($result['ACK'] == 'Success') {
				...
				$this->response->redirect($this->url->link('payment/pp_express/expressConfirm', '', true));
				//$this->response->redirect($this->url->link('payment/pp_express/expressReturn', '', true));
			}
		} else {
