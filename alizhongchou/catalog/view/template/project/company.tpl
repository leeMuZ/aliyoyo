				...
				<div class="validate">
					<div class="validateleft col-md-8 col-sm-8">
						<ul class="validateleftul ">
							<li class=""><a class="validateleftul-li-hover" href="#project"><i class="fa fa-check-circle validateleftul-li-i-active <?php  if($project_form){ echo "complete";}?>"></i>产品信息</a></li>
							<li class=""><a href="#reward"><i class="fa fa-check-circle <?php  if($rewards_form){ echo "complete";}?>"></i>奖金设置</a></li>
							<li class=""><a href="#description"><i class="fa fa-check-circle <?php  if($description_form){ echo "complete";}?>"></i>产品详情</a></li>
							<li class=""><a href="#account"><i class="fa fa-check-circle <?php  if($companyInfo_form){ echo "complete";}?>"></i>公司认证</a></li>
							...
							<!-- <p class="information-p">企业证件信息</p> -->
							    <div class="form-group">
							    	...
							    	<div class="col-sm-8 certificate xiangmutupian">
								    	<div class="large_img_div">
											...
											<input type="file"  multiple="multiple"  class="form-control form-control-largeimg uploading">
											<input  type="hidden" name="project_image"  class="upload_url" value="<?php  echo $project['image']?>">
							  	...
							  	<div class="form-group">
							    	...
							    	<div class="col-sm-8 certificate ">
							      		<input type="text" class="form-control " required name="project_name" value="<?php  echo $name ?>" id="projectmingc" maxlength="60"   >
							    ...
							    <div class="form-group">
							    	...
							    	<div class="col-sm-8 certificate ">
							      		...
							      		<textarea  class="form-control " name="project_introduce"  rows="4"  maxlength="135" ><?php  echo $introduce ?></textarea>
							      		   <?php if (!empty($error_introduce)) { ?>
							    ...
							    <div class="form-group">
							    	...
							    	<div class="col-sm-8 certificate zhouqi">
							    		<span class="action-data">开始时间</span>
							      		<input type="text" class="form-control col-sm-6 action-input action-inputfirst-child" value="<?php  echo $project['date_start']?>" name="date_start" id="date_start" onClick="laydate({elem:'#date_start',choose:DateCallBack})">
							      		<span class="action-data action-inputlast-child">结束时间</span>
							      		<input type="text" class="form-control clo-sm-6 action-input " name="date_ended" value="<?php  echo $project['date_ended']?>" id="date_ended" onClick="laydate({elem:'#date_ended',choose:DateCallBack})">
						...
						<div class="validate-table-one col-md-push-1 col-md-10 col-sm-12" id="appfather">	
								<ol class="getabonus col-md-push-2 col-md-8 col-sm-push-1 col-sm-10 fields rewards m0">
								   <?php foreach ($rewards as $key=>$reward){?>
									 <?php if (!empty($error_tile)) {
                                        foreach($error_tile as $k=>$v){
										  $arr=explode('_',$v);
										  
										?>
								        <?php if($arr[1]==$key) {?>
                                      <p class="text-danger" style="font-size:12px;text-align:center"><?php echo $arr[0]; ?></p>
									 <?php } }}?>										
									<?php if (!empty($error_pledge_amount)) { 
                                        foreach($error_pledge_amount as $k=>$v){
										  $earr=explode('_',$v);									
									?>
									 <?php if($earr[1]==$key) {?>
                                      <p class="text-danger" style="font-size:12px;text-align:center"><?php echo $earr[0]; ?></p>
									<?php }}} ?>
                                        ...
                                        <div class="getabonus-right col-sm-10">
                                            ...
                                            <div class="form-group biaogeform">
                                                ...
                                                <div class="col-sm-9 biaogediv reward_description" >
                                                    <textarea  rows="4"  class="form-control biaogeinput biaogeinput-three" 
                                                    ...
                                                    <div class="moremoney">
                                                    	...
                                                    	<div class="money-div">
                                                    		...
                                                    		<div class="col-sm-4 datarili-div shijianxian">
													      		<input type="text" class="form-control shijianxian-input" placeholder="结束" id="reward_start<?php  echo $key?>" onClick="laydate({elem:'#reward_start<?php  echo $key?>',choose:DateCallBack})" name="reward[<?php echo $key;?>][limit_time_end]" value="<?php  if($reward['limit_time_availability']){echo $reward['limit_time_end'];}?>">
													      	</div>
													      	<div class="col-sm-4 datarili-div shijianxian">
													      		<input type="text"  class="form-control shijianxian-input" placeholder="开始" id="reward_end<?php  echo $key?>" onClick="laydate({elem:'#reward_end<?php  echo $key?>',choose:DateCallBack})" name="reward[<?php echo $key;?>][limit_time_begin]" value="<?php  if($reward['limit_time_availability']){echo $reward['limit_time_begin'];}?>">
						...
						<div class="validate-table-one col-md-push-1 col-md-10 col-sm-12">
							    ...
							    <div class="form-group">
							    	...
							    	<div class="col-sm-8 certificate ">
										...
										<textarea name="risk_description"  rows="10" class="form-control form-control-fenxian" ><?php  echo $risk_description ?></textarea>
										   <?php if (!empty($risk_de)) { ?>
                                              <div class="text-danger"><?php echo $risk_de; ?></div>
                                           <?php } ?>							      	
									</div>
							    </div>
						</div>	
							    ...
							    <div class="form-group">
							  	...
							  	<div class="form-group">
							    	...
							    	<div class="col-sm-4 datarili-div">
							      		<input type="text" class="form-control" id="registeredTime" onClick="laydate({elem: '#registeredTime',choose:DateCallBack})" name="registeredTime" value="<?php  echo $companyInfo['registeredTime']?>">
							    	</div>
							  	</div>
							  	<div class="form-group">
				...
				<div class="campaigntable campaigntableall-active">
					...
					<div class="shenhexiangmu  col-md-push-1 col-md-10 col-sm-12">
						...
						<div class="col-sm-12 clearfix ">
							...
							<div class="col-sm-3  decrition">
								<a href="<?php  echo $editUrl;?>"><button class="btn editProject" >重新编辑</button></a>
							</div>
							<?php if(isset($publishUrl)){?>
							<div class="col-sm-3  decrition">
								<a href="<?php  echo $publishUrl;?>"><button class="btn editProject" >发布项目</button></a>
							</div>
							<?php }?>
						</div>
						<?php }?>
	          ...
	          if($(".validate-preserve").is(":hidden")){
	              ...
	              $(".fa-check-circle").each(function(){
	                    if(!$(this).hasClass("complete")){
	                  	  $(this).attr("class","fa fa-exclamation-circle warning");
	                        }else{
	                      	  num++;
	                            }
