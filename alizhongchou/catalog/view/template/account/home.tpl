...
<div class="standard-body">
	<div id="header" class="row">
		<div class="vcard-canopy">	
           <?php  if(empty($uid) || $uid==$self){ ?>		
			 <img src="<?php echo HTTP_Aliyoyo.'image/'.$back['background_image'] ?>" id="uploadbackgroud" class="img_up" style="height:auto">
		   <?php }else{ ?>
			 <img src="<?php echo $back_img ?>" id="uploadbackgroud" class="img_up" style="height:auto" >		  
		  <?php } ?>
