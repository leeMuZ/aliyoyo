<?php
// HTTP
define('HTTP_SERVER', 'http://127.0.0.1:83/admin/');
define('HTTP_CATALOG', 'http://127.0.0.1:83/');

// HTTPS
define('HTTPS_SERVER', 'http://127.0.0.1:83/admin/');
define('HTTPS_CATALOG', 'https://127.0.0.1:83/');

// DIR
define('DIR_APPLICATION', 'E:/aliyoyoPhp/alizhongchou/admin/');
define('DIR_SYSTEM', 'E:/aliyoyoPhp/alizhongchou/system/');
define('DIR_IMAGE', 'E:/aliyoyoPhp/alizhongchou/image/');
define('DIR_S3IMAGE', 'http://image.aliyoyo.com/image/');
define('DIR_LANGUAGE', 'E:/aliyoyoPhp/alizhongchou/admin/language/');
define('DIR_TEMPLATE', 'E:/aliyoyoPhp/alizhongchou/admin/view/template/');
...
define('DIR_CATALOG', 'E:/aliyoyoPhp/alizhongchou/catalog/');
