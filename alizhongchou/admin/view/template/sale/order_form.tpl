          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-express-num"><?php echo 'Express Num'; ?></label>
                  <div class="col-sm-10">
                    <div class="input-group">
                      <input type="text" name="express_num" value="<?php if($express_num)echo $express_num; ?>" id="input-express-num" class="form-control" />
                      <span class="input-group-btn">
                      <button onclick="checkExpressNum()" type="button" id="button-express-num" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_apply; ?></button>
                      </span></div>
                  </div>
                </div>   
                <div class="form-group">
...
$('#button-save').on('click', function() {
	...
	$.ajax({
		url: url,
		type: 'post',
		data: $('select[name=\'payment_method\'] option:selected,  select[name=\'shipping_method\'] option:selected,  #tab-total select[name=\'order_status_id\'], #tab-total input[name=\'express_num\'], #tab-total select, #tab-total textarea[name=\'comment\'], #tab-total input[name=\'affiliate_id\']'),
		dataType: 'json',
		crossDomain: true,
		beforeSend: function() {
