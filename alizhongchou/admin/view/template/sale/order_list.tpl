        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-nickname"><?php echo $entry_nickname; ?></label>
                <input type="text" name="filter_nickname" value="<?php echo $filter_nickname; ?>" placeholder="<?php echo $entry_nickname; ?>" id="input-nickname" class="form-control" />
              </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'nickname') { ?>
                    <a href="javascript:void(0);" class="<?php echo strtolower($order); ?>"><?php echo $column_nickname; ?></a>
                    <?php } else { ?>
                    <a href="javascript:void(0);"><?php echo $column_nickname; ?></a>
                    <?php } ?></td>
                     <td class="text-left"><?php if ($sort == 'email') { ?>
                    <a href="javascript:void(0);" class="<?php echo strtolower($order); ?>"><?php echo $column_email; ?></a>
                    <?php } else { ?>
                    <a href="javascript:void(0);"><?php echo $column_email; ?></a>
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'order_status') { ?>
                    <a href="javascript:void(0);" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                    <a href="javascript:void(0);"><?php echo $column_status; ?></a>
                    <?php } ?></td>
...
$('button[id^=\'button-delete\']').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		var node = this;
		$.ajax({
			//url: 'index.php?route=api/order/delete&token=' + token + '&order_id=' + $(node).val(),
			type: 'get',
			url: '<?php echo $store_url; ?>index.php?route=api/order/delete',
