      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-rating" data-toggle="tab"><?php echo 'Evaluation Rating'; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-rating">
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-rating"><?php echo 'Evaluation Rating'; ?></label>
                <div class="col-sm-10">
                  <select name="rating_cat_id" id="input-rating" class="form-control">
                    <?php foreach ($rating_cats as $rating_cat) { ?>
                    <?php if ($rating_cat['rating_cat_id'] == $rating_cat_id) { ?>
                    <option value="<?php echo $rating_cat['rating_cat_id']; ?>" selected="selected"><?php echo $rating_cat['rating_cat_name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $rating_cat['rating_cat_id']; ?>"><?php echo $rating_cat['rating_cat_name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-report"><?php echo 'Report'; ?></label>
                <div class="col-sm-10">
                	<input type="text" name="report" value="<?php echo $report; ?>" id="input-report" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-coupon"><?php echo 'Coupon'; ?></label>
                <div class="col-sm-10">
               ...
               <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-rating"><?php echo 'Product Type'; ?></label>
                <div class="col-sm-10">
                  <select name="product_type" id="input-product-type" class="form-control">
                    <option value="<?php echo "self-support";?>"><?php echo "self-support";?></option>
                    <option value="<?php echo "recommend"; ?>"><?php echo "recommend"; ?></option>
                  </select>
                </div>
                <?php if($product_type){?>
                <script>
                $("[name='product_type']").val("<?php echo $product_type;?>");
                </script>
                <?php }?>
              </div>
              <div class="form-group recommend_href">
                <label class="col-sm-2 control-label" for="input-coupon"><?php echo 'Recommend Href'; ?></label>
                <div class="col-sm-10">
                	<input type="text" name="recommend_href" value="<?php echo $recommend_href; ?>" id="input-recommend-href" class="form-control" />
                </div>
              </div>
              <script>
              if($("[name='product_type']").val() == "self-support"){
                  $(".recommend_href").hide();
              }
              $("[name='product_type']").change(function(){
                  var product_type=$(this).val();
                  if(product_type == "self-support"){
                      $(".recommend_href").hide();
                  }else if(product_type == "recommend"){
                	  $(".recommend_href").show();
                  }
              });
              </script>
            ...
            <div class="tab-pane" id="tab-image">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left" colspan='2'><?php echo $entry_image; ?></td>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left youtubeVideoPlay">
                      <?php if(empty($video)){?>
                      	<input type="hidden" name="video" value=""/>
                      	<i class="fa fa-film" data-toggle="modal" data-target="#videoModal" data-whatever="@mdo" style="width: 100px;height: 100px;font-size: 90px;"></i>
                      <?php }else{?>
                      	<input type="hidden" name="video" value="<?php echo $video;?>"/>
                      	<div style="float:left;"><iframe width="260" height="100" src="<?php echo $video;?>" frameborder="0" allowfullscreen></iframe></div>
                      	<div style="float:left;margin-left: 50px;">
                      		<button style="display:block;margin-bottom: 30px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#videoModal" data-whatever="@mdo">Edit Video</button>
                      		<button style="display:block;" type="button" class="btn btn-primary" onclick="deleteVideo()">Delete Video</button>
                      	</div>
                      <?php }?>
                      </td>
                  </tr>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <h4 class="modal-title" id="exampleModalLabel">Insert Video</h4>
				      </div>
				      <div class="modal-body">
				         <div class="form-group" style="margin-left:0;margin-right:0;">
						    <label for="exampleInputVideo">Video URL?(only YouTube)</label>
						    <input type="text" class="form-control" id="exampleInputVideo" value="<?php echo ltrim($video,"//");?>">
						  </div>
				      </div>
				      <div class="modal-footer">
				       <button type="button" class="btn btn-primary" onclick="checkVideoIsYoutobe()">Insert Video</button>
				      </div>
				    </div>
				  </div>
				</div>
