			...
			<div class="content">
				<div>
					<div class="tabs clearfix">
						...
						<?php $module_row = 1; $modules_count = 1; $columns_count = 1; $links = 1; $products_tabs = 1; $collections = 1 ?>
						   	          ...
						   	          <?php } ?>
						   	           ...
						   	           <?php } ?>
						   	           				...
						   	           				<div class="input clearfix">
						   	           					...
						   	           					<div class="list-language">
						   	           <?php foreach ($languages as $language) { ?>
						   	           						<div class="language"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][products_tabs][href][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($column_module['products_tabs']['href'][$language_id])) echo $column_module['products_tabs']['href'][$language_id]; ?>" <?php if($column_module['type'] != 'products_tabs') echo 'disabled="disabled"'; ?>></div>
						   	           <?php } ?>
						   	           					</div>
						   	           				</div>
						   	              				<div class="input clearfix">
						   	             ...
						   	             <?php foreach($templates as $template) {
						   	                  if(isset($collection_templates[$template])) {
						   	                       ...
						   	                       foreach($collection_templates[$template] as $file_template) { ?>
						   	                                                     <div class="module-layout clearfix">
						   	                                                          <input type="radio" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][module_layout]" value="<?php echo $file_template; ?>" checked="checked" class="input-module-layout" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?>>
						   	                                                          <p><?php echo $file_template; ?></p>
						   	                                                     </div>
						   	                       <?php $i++; }
						   	                  }
						   	           				...
						   	           				<div class="input clearfix">
						   	           					...
						   	           					<div class="list-language">
						   	           <?php foreach ($languages as $language) { ?>
						   	           						<div class="language"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][title][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($column_module['collections']['title'][$language_id])) echo $column_module['collections']['title'][$language_id]; ?>" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?>></div>
						   	           <?php } ?>
						   	           					</div>
						   	           				</div>
   	           										<div class="input clearfix">
						   	          					<p>Image dimension (W x H) and Resize Type:</p>
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][latest_blogs][width]" value="<?php if(isset($column_module['latest_blogs']['width'])) echo $column_module['latest_blogs']['width']; ?>" style="width:50px;margin-right: 5px" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?> >
						   	          					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][latest_blogs][height]" value="<?php if(isset($column_module['latest_blogs']['height'])) echo $column_module['latest_blogs']['height']; ?>" style="width: 50px" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?> >
						   	          				</div>
						   	              				
						   	            
						   	            				<div class="input clearfix">
						   	            					<p>Limit collections:</p>
						   	            					<input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][limit]" value="<?php if(isset($column_module['collections']['limit'])) echo $column_module['collections']['limit']; ?>" style="width: 50px" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?>>
						   	            				</div>
						   	            				...
						   	            				<table id="collections-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-<?php echo $s; ?>">
						   	            					...
						   	            					<?php if(isset($column_module['collections']['collection'])) { foreach ($column_module['collections']['collection'] as $collection) { ?>
						   	            					     ...
						   	            					     <tr>
						   	            					          ...
						   	            					          <?php foreach ($languages as $language) { ?>
						   	            					               <div class="language">
						   	            					                    <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
						   	            					                    <input type="text" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][collection][<?php echo $collections; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php $language_id = $language['language_id']; if(isset($collection['title'][$language_id])) echo $collection['title'][$language_id]; ?>" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?>>
						   	            					               </div>
						   	            					          <?php } ?>
						   	            					          </div></td>
						   	            					          ...
						   	            					          <td id="module-<?php echo $module_row; ?>-<?php echo $columns_count; ?>-module-<?php echo $s; ?>-<?php echo $collections; ?>">
						   	            				                    <div class="input clearfix">
						   	            				                         ...
						   	            				                         <div style="float:left;width:425px">
						   	            				                              <select name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][collection][<?php echo $collections; ?>][get_products_from]" class="get-collection" id="<?php echo $module_row; ?>-<?php echo $columns_count; ?>-module-<?php echo $s; ?>-<?php echo $collections; ?>" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?>>
						   	            				                              ...
						   	            				                              <div class="filter_<?php echo $module_row; ?>_<?php echo $columns_count; ?>_<?php echo $s; ?>_<?php echo $collections; ?>_collections panel-collections-autocomplete"<?php if($collection['get_products_from'] != 'collections') echo ' style="display: none"'; ?>>
						   	            				                                   <div class="collections-autocomplete clearfix">
						   	            				                                        ...
						   	            				                                        <div><input type="text" alt="<?php echo $module_row; ?>" title="<?php echo $columns_count; ?>" id="<?php echo $s; ?>-<?php echo $collections; ?>" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][collection][<?php echo $collections; ?>][product]" value="" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?> /></div>
						   	            				                                   </div>
						   	            				                              	<div class="scrollbox collections">
						   	            				                                   ...
						   	            				                                   <input type="hidden" name="advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][collection][<?php echo $collections; ?>][products]" value="<?php if(isset($collection['products'])) echo $collection['products']; ?>" <?php if($column_module['type'] != 'collections') echo 'disabled="disabled"'; ?> />
						   	            				                              </div>
						   	            					...
						   	            					<script>
						   	            					$('input[name=\'advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][collection][<?php echo $collections; ?>][product]\']').autocomplete({
						   	            					     	delay: 500,
						   	            					     	source: function(request, response) {
						   	            					     		$.ajax({
						   	            					     	...
						   	            					     	select: function(item) {
						   	            					     		...
						   	            					     		$('input[name=\'advanced_grid_module[<?php echo $module_row; ?>][column][<?php echo $columns_count; ?>][module][<?php echo $s; ?>][collections][collection][<?php echo $collections; ?>][products]\']').attr('value', data.join());
...
function addCollection(module_row, column, modules) {
	...
	html += '			<div class="language">';
	html += '				<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />';
	html += '				<input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][collection][' + collections + '][title][<?php echo $language['language_id']; ?>]">';
	html += '			</div>';
	<?php } ?>
	html += '		</div></td>';
	html += '		<td id="module-' + module_row + '-' + column + '-module-' + modules + '-' + collections + '">';
     ...
     html += '					<p>Get products from:</p>';
     html += '					<div style="float:left;width:425px">';
     html += '						<select name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][collection][' + collections + '][get_products_from]" class="get-collection" id="' + module_row + '-' + column + '-module-' + modules + '-' + collections + '">';
     ...
     html += '									<div><input type="text" alt="' + module_row + '" title="' + column + '" id="' + modules + '-' + collections + '" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][collection][' + collections + '][product]" value="" /></div>';
     html += '							</div>';
     html += '							<div class="scrollbox collections"></div>';
     html += '							<input type="hidden" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][collection][' + collections + '][products]" value="" />';
     html += '						</div>';
	...
	$('input[name=\'advanced_grid_module[' + module_row + '][column][' + column + '][module][' + modules + '][collections][collection]['+modules4+'][product]\']').autocomplete({
     	delay: 500,
     	source: function(request, response) {
     		$.ajax({
     			url: 'index.php?route=customer/collection/autocompleteCollection&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
     	...
     	select: function(item) {
			...
			$('input[name=\'advanced_grid_module[' + module_row + '][column][' + column + '][module][' + modules + '][collections][collection][' + modules4 + '][products]\']').attr('value', data.join());
...
html += '			<div class="collections" style="display: none">';
	...
	<?php foreach($templates as $template) {
	     if(isset($collection_templates[$template])) {
	          ...
	          foreach($collection_templates[$template] as $file_template) { ?>
	               html += '                         <div class="module-layout clearfix">';
	               html += '                              <input type="radio" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][module_layout]" value="<?php echo $file_template; ?>" <?php if($i == 0) echo 'checked="checked"'; ?> class="input-module-layout">';
	               html += '                              <p><?php echo $file_template; ?></p>';
	               html += '                         </div>';
	          <?php $i++; }
	     }
	...
	html += '					<div class="list-language">';
	<?php foreach ($languages as $language) { ?>
	html += '						<div class="language"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][title][<?php echo $language['language_id']; ?>]" value=""></div>';
	<?php } ?>
	html += '					</div>';
	html += '				</div>';
	...
	html += '					<input type="text" name="advanced_grid_module['+ module_row +'][column][' + column + '][module][' + modules + '][collections][limit]" value="3" style="width: 50px">';
	html += '				</div>';
...
jQuery(document).ready(function($) {
     ...
     $('body').on('click', '.scrollbox.collections img', function () {
    	...
    	$('input[name=\'advanced_grid_module[' + $(this).attr("alt") + '][column][' + $(this).attr("title") + '][module][' + $(this).attr("id") + '][collections][collection][' + $(this).attr("value") + '][products]\']').attr('value', data.join());
    });
