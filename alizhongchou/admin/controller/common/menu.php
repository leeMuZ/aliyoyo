...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['config_livehelp_state'] = (int)$this->config->get('livehelp_status');
		//add by ygami at 20160623 begin
		$data['text_livehelp_setting'] = $this->language->get('text_livehelp_setting');
		$data['text_livehelp_status'] = $this->language->get('text_livehelp_status');
		$data['text_livehelp_ban'] = $this->language->get('text_livehelp_ban');
		$data['text_livehelp_user'] = $this->language->get('text_livehelp_user');
		$data['text_livehelp_data_warehouse'] = $this->language->get('text_livehelp_data_warehouse');
		$data['text_livehelp'] = $this->language->get('text_livehelp');
		
		$data['livehelp_setting'] = $this->url->link('livehelp/livehelp_setting', 'token=' . $this->session->data['token'], 'SSL');
		$data['livehelp_status'] = $this->url->link('livehelp/livehelp_status', 'token=' . $this->session->data['token'], 'SSL');
		$data['livehelp_ban'] = $this->url->link('livehelp/livehelp_ban', 'token=' . $this->session->data['token'], 'SSL');
		$data['livehelp_user'] = $this->url->link('livehelp/livehelp_user', 'token=' . $this->session->data['token'], 'SSL');
		$data['livehelp_data_warehouse'] = $this->url->link('livehelp/livehelp_data_warehouse', 'token=' . $this->session->data['token'], 'SSL');
		//add by ygami at 20160623 end
		...
		$data['text_report_product_search'] = $this->language->get('text_report_product_search');
		...
		$data['text_report_customer_order'] = $this->language->get('text_report_customer_order');
		//add by yss @2016-12-08 customer_like
		$data['text_report_customer_like'] = $this->language->get('text_report_customer_like');
		$data['text_report_customer_list'] = $this->language->get('text_report_customer_list');
		...
		$data['model'] = $this->url->link('catalog/model', 'token=' . $this->session->data['token'], true);
		...
		$data['report_product_search'] = $this->url->link('report/product_search', 'token=' . $this->session->data['token'], true);
		...
		$data['reviews'] = $this->url->link('catalog/reviews', 'token=' . $this->session->data['token'], true);

		//add by yss @2016-12-08 customer_like
		$data['report_customer_like'] = $this->url->link('report/customer_like', 'token=' . $this->session->data['token'], true);
		$data['report_customer_list'] = $this->url->link('report/customer_list', 'token=' . $this->session->data['token'], true);
		...
		$data['blog'] = $this->url->link('module/blog', 'token=' . $this->session->data['token'], true);
		$data['text_blog'] = 'Blog';		
