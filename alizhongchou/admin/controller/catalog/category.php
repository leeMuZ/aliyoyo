...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				'category_id' => $result['model_category_id'],
				'name'        => $result['name'],
				'sort_order'  => $result['sort_order'],
				'edit'        => $this->url->link('catalog/category/edit', 'token=' . $this->session->data['token'] . '&category_id=' . $result['model_category_id'] . $url, true),
				'delete'      => $this->url->link('catalog/category/delete', 'token=' . $this->session->data['token'] . '&category_id=' . $result['model_category_id'] . $url, true)
			);
		}
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['keyword']) > 0) {
			...
			if ($url_alias_info && isset($this->request->get['category_id']) && $url_alias_info['query'] != 'model_category_id=' . $this->request->get['category_id']) {
